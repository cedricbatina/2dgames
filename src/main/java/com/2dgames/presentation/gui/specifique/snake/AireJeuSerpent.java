package com.2dgames.presentation.gui.specifique.snake;
...
public void appuiTouche(int code) {
 switch (code) {
  case KeyEvent.VK_UP: moteur.toucheHaut(); 
   
   break;
   case KeyvEvent.VK_DOWN: moteur.toucheBas(); break;
   case KeyEvent.VK_LEFT: moteur.toucheGauche(); break;
   case KeyEvent.VK_RIGHT: moteur.toucheDroite();
